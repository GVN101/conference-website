...
//                     <MapPin className="h-6 w-5 text-blue-600" aria-hidden="true" />
//                   </dt>
...
//                   </dt>
//                   <dd className="text-sm leading-6 text-gray-600">
//                     +91-479- 2455125 (Reception) +91-479-2454125 (Office) +91-479-2456046 (Principal)
//                   </dd>
//                 </div>
//                 <div className="flex gap-x-4">
//                   <dt className="flex-none">
            ...
            <div className="rounded-2xl bg-gray-50 p-8">
              ...
              <dl className="mt-8 space-y-6">
                ...
                <div className="flex gap-x-4">
                  ...
                  <dd className="text-sm leading-6 text-gray-600">
                    +91-479- 2455125 (Reception)<br />+91-479-2454125 (Office)<br />+91-479-2456046 (Principal)
                  </dd>
                </div>
                <div className="flex gap-x-4">
                  <dt className="flex-none">
