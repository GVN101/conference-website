...
//               <div className="mt-6 flex flex-col sm:flex-row gap-4">
//                 <a
//                   href="https://yourwebsite.com/poster-guidelines.pdf"
//                   target="_blank"
//                   rel="noopener noreferrer"
//                   className="flex items-center justify-center bg-gray-800 hover:bg-gray-700 text-white font-medium px-4 py-2 rounded-lg shadow transition"
//                 >
//                   <Download className="mr-2 h-5 w-5" /> Download Guidelines
//                 </a>
//                 <a
//                   href="https://yourwebsite.com/poster-template.pdf"
//                   target="_blank"
//                   rel="noopener noreferrer"
//                   className="flex items-center justify-center bg-gray-800 hover:bg-gray-700 text-white font-medium px-4 py-2 rounded-lg shadow transition"
//                 >
