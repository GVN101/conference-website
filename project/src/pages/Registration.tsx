...
//             viewport={{ once: true }}
//             className="mt-16 rounded-lg bg-gray-900 p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-700 text-gray-200"
//           >
...
//               * Please note: Authors must register after the conference paper has been submitted and the paper has been accepted.
//             </p>
//             <div className="mt-4">
//               <a
