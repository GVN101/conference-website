...
//             viewport={{ once: true }}
//             className="mt-16 rounded-lg bg-gray-900 p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-700 text-gray-200 w-full"
//           >
...
//           viewport={{ once: true }}
//           className="mt-8 rounded-lg bg-gray-900 p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-700 text-gray-200 w-full"
//         >
//           <h3 className="text-lg font-semibold flex items-center gap-x-2 text-blue-400">
//             <Upload className="h-6 w-6 text-blue-400" />
//             Poster Submission
...
//           <div className="mt-4">
//             <a
//               href="https://example.com/poster-submission" // Replace with actual link
//               target="_blank"
//               rel="noopener noreferrer"
//               className="inline-block bg-blue-500 text-white font-medium px-6 py-3 rounded-full shadow hover:bg-blue-600 transition"
//             >
