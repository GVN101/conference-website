        ...
        <div className="bg-white py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-16 grid gap-8 md:grid-cols-3">
              {[{ icon: Users, title: "In-Person Experience", description: "Join us on campus for face-to-face networking and interactive sessions.", color: "text-blue-500" },
                { icon: Video, title: "Virtual Attendance", description: "Present and participate from anywhere in the world.", color: "text-purple-500" },
                { icon: Globe, title: "Global Community", description: "Connect with a diverse international audience.", color: "text-green-500" }
              ].map((item, index) => (
                <motion.div
                  key={item.title}
                  initial={{ opacity: 0, y: 20 }}
